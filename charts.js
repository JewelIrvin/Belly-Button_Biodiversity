...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var resultsOTUIDs = result.otu_ids;
    var resultsOTULabels = result.otu_labels;
    var resultsSampleValues = result.sample_values;
    ...
    var bubbleTrace = {
      x: resultsOTUIDs,
      y: resultsSampleValues,
      text: resultsOTULabels,
      mode: "markers",
      marker: {
        size: resultsSampleValues,
        sizeref: 1.4,
        color: resultsOTUIDs,
        colorscale: "Earth"
      },
